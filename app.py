...
app.config['MYSQL_PASSWORD'] = '2004'  # Default password for XAMPP
app.config['MYSQL_DB'] = 'aiplsr'
...
def start_capture():
    ...
    if capture_thread is None or not capture_thread.is_alive():
        capture_thread = Thread(
            ...
            args=("MediaTek MT7921 Wi-Fi 6 802.11ax PCIe Adapter", predictor.predict)
        )
